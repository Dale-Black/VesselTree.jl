...
include("test_contrast_transport.jl")
include("test_contrast_viewer.jl")
include("test_xcat_nrb.jl")
...
include("test_strahler_jiang.jl")
include("test_elements.jl")
include("test_asymmetry.jl")
include("test_pipeline.jl")
include("test_validation_kassab.jl")
include("test_performance.jl")
include("test_export.jl")
include("test_persistence.jl")
include("test_basis_bridge.jl")
include("test_ct_viewer.jl")
